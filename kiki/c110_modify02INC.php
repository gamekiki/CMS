...
//		 die( print_r( mysqli_connect_error(), true) );
	  ...
	  $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
		...
		if ($img != "./kiki/img/test_img1.png" and $img != "./kiki/img/test_img2.png" and $img != "./kiki/img/test_img3.png") {
			$imgname = "4";
			$display = "";
		} else {
			$imgname = "";
...
<form method="post" name="frm" id="frm" enctype="MULTIPART/FORM-DATA">
  ...
  <input type="hidden" name="mgRestrict" value="<?=$mgRestrict?>">
                     ...
                     <table class="tblT01_detail" border="0" cellspacing="0" cellpadding="0">
                       ...
                       <tbody>             
                          <tr>
                            <th>기간 *</th>
                             <td>
                             <input name="beginDate" id="beginDate" class="" value="<?=$startYHS?>" style="width:20%;" type="text" readonly>
                             <a href="#"><img id="calendar1" src="./kiki/img/icon_day.png" alt="달력"></a>
                             ~
                             <input name="EndDate" id="EndDate" class="" value="<?=$endYHS?>" style="width:20%;" type="text" readonly>
                             <a href="#"><img id="calendar2" src="./kiki/img/icon_day.png" alt="달력"></a>
                             </td>
                          </tr>
                          <tr>
                            <th>제목 *</th>
                             <td><label><input name="title" maxlength="10" value="<?=$title?>" placeholder="쇼핑몰에서 위젯 아이콘 상단에 노출됩니다.(최대 10자)" type="text"></label></td>
                          </tr>
                          <tr>
                            <th>내용 </th>
                             <td><label><input name="description" maxlength="20" value="<?=$description?>" placeholder="최대20자" type="text"></label></td>
                          </tr>
                          <tr>
                            <th>위젯 아이콘 </th>
                            <td>
                            <input name="chk_info" value="./kiki/img/test_img1.png" id="c1" <? if($img == "./kiki/img/test_img1.png") { ?> checked="checked"<? } ?> type="radio" onclick="chk_showhide('hide')">
                            <label for="c1"><img src="./kiki/img/test_img_s.png" alt="룰렛이미지"></label>
                           &nbsp;
                            <input name="chk_info" value="./kiki/img/test_img2.png" id="c2" <? if($img == "./kiki/img/test_img2.png") { ?> checked="checked"<? } ?> type="radio" onclick="chk_showhide('hide')">
                            <label for="c2"><img src="./kiki/img/test_img2_s.png" alt="룰렛이미지"></label>
                             &nbsp;
                            <input name="chk_info" value="./kiki/img/test_img3.png" id="c3" <? if($img == "./kiki/img/test_img3.png") { ?> checked="checked"<? } ?> type="radio" onclick="chk_showhide('hide')">
                            <label for="c3"><img src="./kiki/img/test_img_s.png" alt="룰렛이미지"></label>
                            &nbsp;
                            <input name="chk_info" value="4" id="c4" type="radio" <? if($imgname == "4") { ?> checked="checked"<? } ?> onclick="chk_showhide('show')">
                            <label for="c4">직접등록
                            <div id="chk_info_layer" style=" display:<?=$display?>; margin-top:10px"><input name="file1" value="" placeholder="text" type="file"></div>
                            </label>
                            </td>
                          </tr>
                           <tr>
                            <th>참여제한 * </th>
                             <td id="restrict"> 
                               <a href="#" class="kikibtn_point <? if($mgRestrict == "1") { ?>on<? } ?>" id="ksh_shop_show_1" onclick="javascript:ksh_shop_show('ksh_shop_show_1','1');return false;">하루1회</a> <a href="#" class="kikibtn_point <? if($mgRestrict == "A") { ?>on<? } ?>" id="ksh_shop_show_a" onclick="javascript:ksh_shop_show('ksh_shop_show_a','A');return false;">단회</a> 
                             </td>
                          </tr>
                         </tbody>
                      </table>
...
function go_write(){ // 미니 게임 수정
	...
	if ((chk_radio == true) && (document.frm.file1.value.length < 1) && (document.frm.imgname.value != "4") ) {
		alert('위젯 아이콘을 등록해 주세요.');
		document.frm.file1.focus();
	}
    document.frm.action = "./kiki/c110_modify02.php";
	document.frm.submit();
}
</script>