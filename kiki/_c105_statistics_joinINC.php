...
switch ($kind) {
	...
	$wheStr = " (a.appId = '$kiki_appId') and " . $wheStr;	?>
              ...
              <div class="pro_tabarea">           
                ...
                <ul class="tab" id="tab">
                  <li class=""><a href="javascript:go_sub_kiki('./c105_statistics.php')" id="pro_tab01">액티비티</a></li>
                  <li class="on"><a href="javascript:go_sub_kiki('./c105_statistics_join.php')" id="pro_tab02">가입자</a></li>
